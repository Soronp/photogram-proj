...
- Nearest-neighbor distance statistics (mean / median)
...
def run_dense_evaluation(project_root: Path):
    ...
    if not dense_ply.exists():
        raise FileNotFoundError("Dense point cloud not found: fused.ply")
    ...
    # Sample if extremely large (deterministic stride)
...
def main():
    ...
    run_dense_evaluation(args.project_root)
